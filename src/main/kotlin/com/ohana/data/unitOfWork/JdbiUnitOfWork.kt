...
class JdbiUnitOfWorkContext(
    ...
    override val permissions: PermissionRepository = JdbiPermissionRepository(handle)
    override val tagPermissions: TagPermissionRepository = JdbiTagPermissionRepository(handle)
